package com.dpbr.dpbrbe.global.jwt;
...
import com.dpbr.dpbrbe.global.auth.usecase.AuthDetailsService;
import com.dpbr.dpbrbe.domain.shared.Role;
import com.dpbr.dpbrbe.global.jwt.dto.response.JwtResponse;
import com.dpbr.dpbrbe.global.jwt.exception.ExpiredTokenException;
import com.dpbr.dpbrbe.global.jwt.exception.InvalidTokenException;
import com.dpbr.dpbrbe.global.jwt.exception.MalformedTokenException;
import com.dpbr.dpbrbe.global.jwt.exception.UnsupportedTokenException;
...
public class JwtProvider {
	...
	public JwtResponse refreshAccessToken(String refreshToken) {
		...
		String newAccessToken = generateAccessToken(userId, claims.getSubject(), Role.valueOf(role));
	...
	public String generateRefreshToken(Long userId, String tokenSubject, Role role) {
		return generateToken(userId, tokenSubject, REFRESH_TOKEN_DURATION, role);
	}
